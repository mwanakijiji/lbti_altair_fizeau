...
class FakePlanetInjectorCube:
    ...
    def __init__(self,
        ...
        config_data: configuration data, as usual
        recenter: option to re-center the image after injection of fake planet
            (this checks for systematics introduced by centering real images first, and then
    ...
    def __call__(self,
        ...
        for frame_num in range(0,len(abs_sci_name_array)):
            ...
            # option to re-center the frame
            if self.recenter:
                image_w_fake_planet = simple_center(image_w_fake_planet)
...
class SyntheticFizeauInjectRemoveADI:
    ...
    def __init__(self,
        ...
        self.recenter_option = recenter_option
...
def main(inject_iteration=None):
    ...
    if (inject_iteration == 0):
        ...
        fake_params_pre_permute = {"angle_deg_EofN": [353.37,0.04,140.32,160.782],
                               "rad_asec": list(B),
        ...
        # Block D, strip 1 of 4: 70.782 / 250.782 (-19.218 along short baseline)
